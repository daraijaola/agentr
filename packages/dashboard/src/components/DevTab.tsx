...
const MODELS = [
  { id: 'air', label: 'BTL-2 (Default)', desc: 'Flagship BTL Runtime model' },
  { id: 'max', label: 'BTL-2 Max', desc: 'Best for complex contracts' },
  { id: 'flash', label: 'BTL-2 Flash', desc: 'Fast + smart' },
  { id: 'codex', label: 'BTL Code', desc: 'Code-first reasoning' },
  { id: 'gpt4', label: 'BTL Mini', desc: 'General purpose' },
]
